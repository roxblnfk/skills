...
#[Covers(SkillsJsonDonorRefSource::class)]
...
final class SourceProviderEndToEndTest
{
    ...
    public function SourceEntryResolvesFetchesAndProducesDonor(): void
    {
        ...
        $source = new SkillsJsonDonorRefSource($registry);
        $fetcher = new HttpArchiveFetcher($http, Path::create($this->tmp));
        $provider = new SourceProvider($source, $fetcher);
    ...
    public function gitlabSourceEntryResolvesFetchesAndProducesDonor(): void
    {
        ...
        $provider = new SourceProvider(
            new SkillsJsonDonorRefSource(new HostAdapterRegistry(new GitlabAdapter($http))),
